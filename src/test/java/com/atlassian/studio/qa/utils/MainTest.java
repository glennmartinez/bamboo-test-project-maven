...
public class MainTest extends TestCase
{
    ...
    public void testApplicationWadl() throws InterruptedException
    {
        for (int i = 0; i < 1; i++)
        {
            log.info("I am just sleeping...again oh siesta");
    ...
    public void testRubbishGeneration()
    {
        ...
        {
            log.error("Rubbish generation failed buddy, pls try again fix the changesone more time.", e);
        }
    }
    ...
    public void testRubbishGeneration2()
    {
        ...
        {
            log.error("Rubbish generation failed dudetesting pls try again.", e);
        }
    }
