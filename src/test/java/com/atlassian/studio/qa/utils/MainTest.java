...
public class MainTest extends TestCase
{
    ...
    public void testRubbishGeneration()
    {
        ...
        {
            log.error("Rubbish generation failed buddy, pls try againdfdfdfdthis bug stops here dudes.", e);
        }
    }
    ...
    public void testRubbishGeneration2()
    {
        ...
        {
            log.error("Rubbish generation failed dude bad boy code that again.", e);
        }
    }
